...
print("Original JSON file size: {:,} Bytes".format(os.path.getsize("/home/rafael/Agile_Data_Code_2-master/data/simple_flight_delay_features.jsonl")))
training_data = utils.read_json_lines_file('/home/rafael/Agile_Data_Code_2-master/data/simple_flight_delay_features.jsonl')
